...
namespace SIDCOP_Backend.DataAccess.Repositories.General
{
     public class MarcaRepository: IRepository<tbMarcas>
    {
        ...
        public RequestStatus InsertMarca(tbMarcas item)
        {
            if (item == null)
            {
            ...
            parameter.Add("@Marc_Descripcion", item.Marc_Descripcion, System.Data.DbType.String, System.Data.ParameterDirection.Input);
            parameter.Add("@Usua_Creacion", item.Usua_Creacion, System.Data.DbType.Int32, System.Data.ParameterDirection.Input);
            parameter.Add("@Marc_FechaCreacion", item.Marc_FechaCreacion, System.Data.DbType.DateTime, System.Data.ParameterDirection.Input);

            try
            {
                using var db = new SqlConnection(SIDCOP_Context.ConnectionString);
                var result = db.QueryFirstOrDefault<RequestStatus>(ScriptDatabase.Marca_Insertar, parameter, commandType: System.Data.CommandType.StoredProcedure);
                if (result == null)
                {
